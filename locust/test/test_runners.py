...
class TestMasterRunner(LocustTestCase):
    ...
    def test_slave_connect(self):
        ...
        with mock.patch("API_Load_Test.rpc.rpc.Server", mocked_rpc_server()) as server:
    ...
    def test_spawn_zero_locusts(self):
        ...
        try:
            ...
            self.fail("Got Timeout exception. A API_Load_Test seems to have been spawned, even though 0 was specified.")
        finally:
            timeout.cancel()
