...
from app.Utils.route_relations import RoutesRelation
...
class RequestPoolFactory:
    ...
    def get_unbound_recordings(self, *args):
        UnboundRec =  namedtuple("UnboundRec", ["rec_guid", "sched_guid", "dvr_host"])
        route_name, env = "Bind Recording", "DEV2"
